				...
				<div id="content">
					...
					<div class="content-related">
						<?php while ($my_query->have_posts()) : $my_query->the_post();
							...
							<article class="blk_categories_related">
								<article class="article-top" style="background-image:url(<?php echo esc_url( $image[0] ); ?>)">
									<a class="lnk-content-post" href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>">
										<div class="blk-info">
											<h3><?php the_title(); ?></h3>
											<p class="posted-by"><?php echo time_ago(); ?> | <span>by <?php echo get_the_author_meta( "display_name" ); ?></span></p>
										</div>
									</a>
									<?php
