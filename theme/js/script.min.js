...
},m(function(){l||(l=1,c(1))},e),i?k.onload():n.parentNode.insertBefore(k,n)},a.yepnope.injectCss=function(a,c,d,e,g,i){var j,e=b.createElement("link"),c=i?h:c||f;e.href=a,e.rel="stylesheet",e.type="text/css";for(j in d)e.setAttribute(j,d[j]);g||(n.parentNode.insertBefore(e,n),m(c,0))}}(this,document),Modernizr.load=function(){yepnope.apply(window,[].slice.call(arguments,0))},jQuery(document).ready(function($){function hasScrolled(){var st=$(this).scrollTop();Math.abs(lastScrollTop-st)<=delta||(st>lastScrollTop&&st>navbarHeight?($("#masthead").removeClass("appear").addClass("disappear"),$(".postActionsNav").removeClass("navAppear").addClass("navDisappear")):st+$(window).height()<$(document).height()&&($("#masthead").removeClass("disappear").addClass("appear"),$(".postActionsNav").removeClass("navDisappear").addClass("navAppear")),$("#masthead").hasClass("appear")?$(".progress-container").css("top","60px"):$("#masthead").hasClass("disappear")&&$(".progress-container").css("top","0px"),lastScrollTop=st)}$("img").addClass("img-fluid"),transformicons.add(".tcon"),$("#showRightPush").click(function(){$(".overlay-contentscale").toggleClass("open"),$("body").toggleClass("pos-fixed"),$("#masthead").toggleClass("whiteBg")}),$(".userIcon").click(function(){$(".contentscale-login").toggleClass("open"),$("body").toggleClass("pos-fixed"),$("#masthead").toggleClass("whiteBg")}),$(".searchIcon").click(function(){$(".overlay-search").addClass("open"),$("body").addClass("pos-fixed")}),$(".close-search").click(function(){$(".overlay-search").removeClass("open"),$("body").removeClass("pos-fixed")}),$('a[href*="#"]:not([href="#"])').on("click",function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var target=$(this.hash);if(target=target.length?target:$("[name="+this.hash.slice(1)+"]"),target.length)return $("html,body").animate({scrollTop:target.offset().top},1e3,function(){$("#masthead").removeClass("appear").addClass("disappear"),$(".postActionsNav").removeClass("navAppear").addClass("navDisappear"),$(".progress-container").css("top","0px")}),!1}}),$(window).scroll(function(){var scroll=$(window).scrollTop();scroll>542?($(".progress-container, .floatingRecommend").addClass("fixed"),$("#masthead").addClass("whiteBg")):($("#masthead").removeClass("whiteBg"),$(".progress-container, .floatingRecommend").removeClass("fixed"))});var getMax=function(){return $(window).height()},getValue=function(){return $(window).scrollTop()};if("max"in document.createElement("div")){var progressBar=$(".progressBar");progressBar.attr({max:getMax()}),$(document).on("scroll",function(){progressBar.attr({value:getValue()})}),$(window).resize(function(){progressBar.attr({max:getMax(),value:getValue()})})}else{var value,width,progressBar=$(".progressBar"),max=getMax(),getWidth=function(){return value=getValue(),width=value/max*100,widthCheck=width,width+="%"},setWidth=function(){progressBar.css({width:getWidth()}),widthCheck>80?$(".floatingRecommend").fadeIn(500):$(".floatingRecommend").fadeOut(500)};$(document).on("scroll",setWidth),$(window).on("resize",function(){max=getMax(),setWidth()})}var didScroll,lastScrollTop=0,delta=5,navbarHeight=$("#masthead").outerHeight();$(window).scroll(function(event){didScroll=!0}),setInterval(function(){didScroll&&(hasScrolled(),didScroll=!1)},250),$('#commentform input[type="text"]').on("change",function(){var singleValues=$(this).val();$(".hs_author .hs-input").val(singleValues)}),$('#commentform input[type="email"]').on("change",function(){var singleValues=$(this).val();$(".hs_email .hs-input").val(singleValues)}),$("#commentform #submit").click(function(){$(".hbspt-form form").submit()})}),jQuery(document).on("submit",".search-form",function(){var $form=jQuery(this),$input=$form.find('input[name="s"]'),query=$input.val(),$content=jQuery("#divscroll");return jQuery("#loader").show(),jQuery.ajax({type:"post",url:ajaxurl,data:{action:"load_search_results",query:query},beforeSend:function(){$input.prop("disabled",!0)},success:function(response){$input.prop("disabled",!1),jQuery("#loader").hide(),$content.html(response)}}),!1}),function(root,factory){"function"==typeof define&&define.amd?define(factory):"object"==typeof exports?module.exports=factory():root.transformicons=factory()}(this||window,function(){"use strict";var tcon={},_transformClass="tcon-transform",DEFAULT_EVENTS={transform:["click"],revert:["click"]},getElementList=function(elements){return"string"==typeof elements?Array.prototype.slice.call(document.querySelectorAll(elements)):"undefined"==typeof elements||elements instanceof Array?elements:[elements]},getEventList=function(events){return"string"==typeof events?events.toLowerCase().split(" "):events},setListeners=function(elements,events,remove){var method=(remove?"remove":"add")+"EventListener",elementList=getElementList(elements),currentElement=elementList.length,eventLists={};for(var prop in DEFAULT_EVENTS)eventLists[prop]=events&&events[prop]?getEventList(events[prop]):DEFAULT_EVENTS[prop];for(;currentElement--;)for(var occasion in eventLists)for(var currentEvent=eventLists[occasion].length;currentEvent--;)elementList[currentElement][method](eventLists[occasion][currentEvent],handleEvent)},handleEvent=function(event){tcon.toggle(event.currentTarget)};return tcon.add=function(elements,events){return setListeners(elements,events),tcon},tcon.remove=function(elements,events){return setListeners(elements,events,!0),tcon},tcon.transform=function(elements){return getElementList(elements).forEach(function(element){element.classList.add(_transformClass)}),tcon},tcon.revert=function(elements){return getElementList(elements).forEach(function(element){element.classList.remove(_transformClass)}),tcon},tcon.toggle=function(elements){return getElementList(elements).forEach(function(element){tcon[element.classList.contains(_transformClass)?"revert":"transform"](element)}),tcon},tcon});